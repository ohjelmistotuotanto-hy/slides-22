...
- Luentoon ehdotettu taukoa -> pidetään tauko
- Yleisökysymykset luennolla ääneen -> yritetään muistaa
- Zoom-mahdollisuus miniprojektiin -> toteutuu
- Stub-luokkien sijainti
- nuolinäppäiment monivalinnoissa
...
- Toiminnallisten vaatimusten dokumentointi voi tapahtua esim.
  ...
  - Ketterissä menetelmissä yleensä _user storyinä_
...
- Storyjen luonne (muistilappu ja lupaus tarkennuksesta) tekee niistä hyvän työkalun projektin aloitukseen
